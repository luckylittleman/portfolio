...
function Contact() {
  ...
  if (state.succeeded) {
    return (
      <main className="page-main" style={{ textAlign: 'center', maxWidth: '500px' }}>
    ...
    <main className="page-main">
      <div className="contact-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
          <div>
            <h1 style={{ fontFamily: "'Inter', sans-serif", fontSize: 'clamp(28px, 5vw, 36px)', fontWeight: '700', color: '#ffffff', margin: '0 0 12px 0' }}>
              Connect With Me
            </h1>
          ...
          <div className="contact-cards">
            ...
            <a href="https://www.linkedin.com/in/hilary-omondi-867209273/" target="_blank" rel="noopener noreferrer" style={cardStyle}
               onMouseEnter={e => { e.currentTarget.style.borderColor = '#6366f1'; e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.04)'; }}
               onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)'; e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.02)'; }}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" style={{ color: '#6366f1', flexShrink: 0 }}><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
              <div style={{ minWidth: 0 }}>
            ...
            {/* Phone Link Card */}
            <a href="tel:+254759865977" style={cardStyle}
               onMouseEnter={e => { e.currentTarget.style.borderColor = '#6366f1'; e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.04)'; }}
               onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.08)'; e.currentTarget.style.backgroundColor = 'rgba(255,255,255,0.02)'; }}>
              <span className="material-symbols-outlined" style={{ color: '#6366f1', fontSize: '24px', flexShrink: 0 }}>call</span>
              <div style={{ minWidth: 0 }}>
            ...
            <div style={{ ...cardStyle, cursor: 'default' }}>
              <span className="material-symbols-outlined" style={{ color: '#6366f1', fontSize: '24px', flexShrink: 0 }}>distance</span>
              <div style={{ minWidth: 0 }}>
